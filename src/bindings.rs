...
#[test]
fn bindgen_test_layout_ANARIExtensions() {
    const UNINIT: ::std::mem::MaybeUninit<ANARIExtensions> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<ANARIExtensions>(),
        188usize,
        concat!("Size of: ", stringify!(ANARIExtensions))
    );
    assert_eq!(
        ::std::mem::align_of::<ANARIExtensions>(),
        4usize,
        concat!("Alignment of ", stringify!(ANARIExtensions))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_LIGHT_DIRECTIONAL) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_LIGHT_DIRECTIONAL)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_LIGHT_POINT) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_LIGHT_POINT)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_LIGHT_RING) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_LIGHT_RING)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_LIGHT_QUAD) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_LIGHT_QUAD)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_LIGHT_HDRI) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_LIGHT_HDRI)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_CAMERA_SHUTTER) as usize - ptr as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_CAMERA_SHUTTER)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_INSTANCE_MOTION_SCALE_ROTATION_TRANSLATION)
                as usize
                - ptr as usize
        },
        24usize,
        concat!(
            ...
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_INSTANCE_MOTION_SCALE_ROTATION_TRANSLATION)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_INSTANCE_MOTION_TRANSFORM) as usize - ptr as usize
        },
        28usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_INSTANCE_MOTION_TRANSFORM)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_INSTANCE_TRANSFORM) as usize - ptr as usize
        },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_INSTANCE_TRANSFORM)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_VOLUME_TRANSFER_FUNCTION1D) as usize
                - ptr as usize
        },
        36usize,
        concat!(
            ...
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_VOLUME_TRANSFER_FUNCTION1D)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_AREA_LIGHTS) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_AREA_LIGHTS)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_ARRAY1D_REGION) as usize - ptr as usize },
        44usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_ARRAY1D_REGION)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_CAMERA_DEPTH_OF_FIELD) as usize - ptr as usize
        },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_CAMERA_DEPTH_OF_FIELD)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_CAMERA_MOTION_TRANSFORMATION) as usize
                - ptr as usize
        },
        52usize,
        concat!(
            ...
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_CAMERA_MOTION_TRANSFORMATION)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_CAMERA_OMNIDIRECTIONAL) as usize - ptr as usize
        },
        56usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_CAMERA_OMNIDIRECTIONAL)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_CAMERA_ORTHOGRAPHIC) as usize - ptr as usize
        },
        60usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_CAMERA_ORTHOGRAPHIC)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_CAMERA_PERSPECTIVE) as usize - ptr as usize
        },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_CAMERA_PERSPECTIVE)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_CAMERA_STEREO) as usize - ptr as usize },
        68usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_CAMERA_STEREO)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_DEVICE_SYNCHRONIZATION) as usize - ptr as usize
        },
        72usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_DEVICE_SYNCHRONIZATION)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_FRAME_ACCUMULATION) as usize - ptr as usize
        },
        76usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_FRAME_ACCUMULATION)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_FRAME_CHANNEL_ALBEDO) as usize - ptr as usize
        },
        80usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_FRAME_CHANNEL_ALBEDO)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_FRAME_CHANNEL_INSTANCE_ID) as usize - ptr as usize
        },
        84usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_FRAME_CHANNEL_INSTANCE_ID)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_FRAME_CHANNEL_NORMAL) as usize - ptr as usize
        },
        88usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_FRAME_CHANNEL_NORMAL)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_FRAME_CHANNEL_OBJECT_ID) as usize - ptr as usize
        },
        92usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_FRAME_CHANNEL_OBJECT_ID)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_FRAME_CHANNEL_PRIMITIVE_ID) as usize
                - ptr as usize
        },
        96usize,
        concat!(
            ...
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_FRAME_CHANNEL_PRIMITIVE_ID)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_FRAME_COMPLETION_CALLBACK) as usize - ptr as usize
        },
        100usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_FRAME_COMPLETION_CALLBACK)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_GEOMETRY_CONE) as usize - ptr as usize },
        104usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_GEOMETRY_CONE)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_GEOMETRY_CURVE) as usize - ptr as usize },
        108usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_GEOMETRY_CURVE)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_GEOMETRY_CYLINDER) as usize - ptr as usize },
        112usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_GEOMETRY_CYLINDER)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_GEOMETRY_QUAD) as usize - ptr as usize },
        116usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_GEOMETRY_QUAD)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_GEOMETRY_QUAD_MOTION_DEFORMATION) as usize
                - ptr as usize
        },
        120usize,
        concat!(
            ...
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_GEOMETRY_QUAD_MOTION_DEFORMATION)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_GEOMETRY_SPHERE) as usize - ptr as usize },
        124usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_GEOMETRY_SPHERE)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_GEOMETRY_TRIANGLE) as usize - ptr as usize },
        128usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_GEOMETRY_TRIANGLE)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_GEOMETRY_TRIANGLE_MOTION_DEFORMATION) as usize
                - ptr as usize
        },
        132usize,
        concat!(
            ...
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_GEOMETRY_TRIANGLE_MOTION_DEFORMATION)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_LIGHT_SPOT) as usize - ptr as usize },
        136usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_LIGHT_SPOT)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_MATERIAL_MATTE) as usize - ptr as usize },
        140usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_MATERIAL_MATTE)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_MATERIAL_PHYSICALLY_BASED) as usize - ptr as usize
        },
        144usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_MATERIAL_PHYSICALLY_BASED)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_RENDERER_AMBIENT_LIGHT) as usize - ptr as usize
        },
        148usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_RENDERER_AMBIENT_LIGHT)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_RENDERER_BACKGROUND_COLOR) as usize - ptr as usize
        },
        152usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_RENDERER_BACKGROUND_COLOR)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_RENDERER_BACKGROUND_IMAGE) as usize - ptr as usize
        },
        156usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_RENDERER_BACKGROUND_IMAGE)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_SAMPLER_IMAGE1D) as usize - ptr as usize },
        160usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_SAMPLER_IMAGE1D)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_SAMPLER_IMAGE2D) as usize - ptr as usize },
        164usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_SAMPLER_IMAGE2D)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_SAMPLER_IMAGE3D) as usize - ptr as usize },
        168usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_SAMPLER_IMAGE3D)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_SAMPLER_PRIMITIVE) as usize - ptr as usize },
        172usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_SAMPLER_PRIMITIVE)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ANARI_KHR_SAMPLER_TRANSFORM) as usize - ptr as usize },
        176usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_SAMPLER_TRANSFORM)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_KHR_SPATIAL_FIELD_STRUCTURED_REGULAR) as usize
                - ptr as usize
        },
        180usize,
        concat!(
            ...
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_KHR_SPATIAL_FIELD_STRUCTURED_REGULAR)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).ANARI_EXP_VOLUME_SAMPLE_RATE) as usize - ptr as usize
        },
        184usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARIExtensions),
            "::",
            stringify!(ANARI_EXP_VOLUME_SAMPLE_RATE)
        )
    );
}
extern "C" {
...
#[test]
fn bindgen_test_layout_ANARI_EXT_debug_interface_s() {
    const UNINIT: ::std::mem::MaybeUninit<ANARI_EXT_debug_interface_s> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<ANARI_EXT_debug_interface_s>(),
        16usize,
        concat!("Size of: ", stringify!(ANARI_EXT_debug_interface_s))
    );
    assert_eq!(
        ::std::mem::align_of::<ANARI_EXT_debug_interface_s>(),
        8usize,
        concat!("Alignment of ", stringify!(ANARI_EXT_debug_interface_s))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).anariInsertStatusMessage) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARI_EXT_debug_interface_s),
            "::",
            stringify!(anariInsertStatusMessage)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).anariNameObject) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(ANARI_EXT_debug_interface_s),
            "::",
            stringify!(anariNameObject)
        )
    );
}
